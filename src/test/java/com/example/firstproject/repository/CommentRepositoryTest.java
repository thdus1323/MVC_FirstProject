...
class CommentRepositoryTest {
    ...
    void findByArticleId() {
        ...
        /*Case 3  : -1번  게시글의 모든 댓글 조회*/
        {
            ...
            //4.비교 및 검증
            assertEquals(expected.toString(), comments.toString(), "-1번 게시글이 없습니다!");
        }
    }
    ...
    /*Case 1 : "Park"의 모든 댓글 조회*/
        {
            ...
            //3. 예상 데이터
            Comment a = new Comment(1L, new Article(4L, "당신의 인생 영화?", "댓글 고"), nickname, "굿 윌 헌팅");
        ...
        /*Case 2 : "Kim"의 모든 댓글 조회*/
        {
            ...
            List<Comment> comments = commentRepository.findByNickname(nickname);
            //3. 예상 데이터
            Comment a = new Comment(2L, new Article(4L, "당신의 인생 영화?", "댓글 고"), nickname, "아이 엠 샘");
